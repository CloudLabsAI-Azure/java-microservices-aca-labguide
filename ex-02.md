...
In this task, you will navigate to the Azure portal to inspect the customers-service container app. Once the replica is running, you view live console logs through the Log Stream feature.
...
1. From the left menu, select **Logs** under monitoring and cancel the tabs by clicking 
**X**.
