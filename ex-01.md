...
1. On the browse tab, navigate to `C:\Labfiles\aca\java-microservices-aca-lab\src\spring-petclinic-admin-server\target` and select the `spring-petclinic-admin-server-3.0.2.jar` file.
...
1. Once the artifact is successfully uploaded, Select **Revision and replicas** from left menu and check the status of replica, which will be in **Activating and Deprovisioning state** state.
...
1. Now that you have uploaded artifact for one service, you have to repeat the steps to upload artifacts for all the services. The artifact file will be diffrent for all service.
   ...
   | ---------------|----------------------|
   | api-gateway    | C:\Labfiles\aca\java-microservices-aca-lab\src\spring-petclinic-api-gateway\target\spring-petclinic-api-gateway-3.0.2.jar |
   | customers-service | C:\Labfiles\aca\java-microservices-aca-lab\src\spring-petclinic-customers-service\target\spring-petclinic-customers-service-3.0.2.jar |
   | vets-service | C:\Labfiles\aca\java-microservices-aca-lab\src\spring-petclinic-vets-service\target\spring-petclinic-vets-service-3.0.2.jar |
   | visits-service | C:\Labfiles\aca\java-microservices-aca-lab\src\spring-petclinic-visits-service\target\spring-petclinic-visits-service-3.0.2.jar |

   >**&#128221;Note:** If the Visits-service container fails, you can igonre it for now. This will be resolved later in this lab.
